...
public class AddressValidatorTest {
    ...
    public void testValidAddress() {
        ...
        assertThatCode(() -> new AddressValidator().build(address).validate()).doesNotThrowAnyException();
    }

    @Test
    public void testAllNullAddress() {
        final Address address = new Address();
        Throwable thrown = catchThrowable(() -> new AddressValidator().build(address).validate());
